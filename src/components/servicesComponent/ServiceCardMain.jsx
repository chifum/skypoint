  ...
  return (
    <div className="bg-[#edeeef] max-w-full relative">
      <div className="container mt-[5rem] mb-[12rem]">
        <div className="w-full overflow-hidden mb-4 flex justify-center items-center">
          <div className="grid md:grid-cols-3 gap-x-8 gap-y-12 sm:grid-cols-1">
            <div className="rounded-[1rem] border-[1px] border-[#007559] h-[579px] w-[405px]">
              <img
                src={serviceImage1}
                alt=""
                height={200}
              ...
              <p className=" pl-8 pr-8 mb-4 text-sm">
