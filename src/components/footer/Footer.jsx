      ...
      <div className="container flex flex-wrap flex-col md:flex-row textColor pt-[4rem]">
        ...
        <div className="grow shrink basis-1/3 overflow-hidden">
          ...
          <div className="p-3">
            ...
            <div>
              <p className=" mt-3">
                We recognize the Traditional Owners of the property on which we
                work and their ongoing custodianship and relationship to the
                land, rivers, and communities.
              </p>
            </div>
          </div>
        </div>
